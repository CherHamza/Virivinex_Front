...
const EmissionsAll = (props) => {
    ...
    console.log('test ', emissionsWithAttributes)
            ...
            <div className="filter-options ">
                ...
                <div className="filter-options">
                    <div className="filter-item">
                        ...
                        <select name="bottleSize" className="form-control" value={filterSize} onChange={handleSizeChange}>
                ...
                <div className="filter-options">
                    <div className="filter-item">
                        ...
                        <select name="bottleCountry" className="form-control" value={filterCountry} onChange={handleCountryChange}>
